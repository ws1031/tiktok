...
class CheckQualificationByProfile():
	def __init__(self):
	...
	def get_users(self):
		users = self.redis_client.get_pre_users(0, 0)
		return users
...
if __name__ == '__main__':
	check_qualification_by_profile = CheckQualificationByProfile()
	check_qualification_by_profile.run()